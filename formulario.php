...
<div class="cabecera"> <a href="<?php echo $apg_shipping['plugin_url']; ?>" title="<?php echo $apg_shipping['plugin']; ?>"><img src="<?php echo $apg_shipping['imagen']; ?>" width="582" height="139" /></a> </div>
