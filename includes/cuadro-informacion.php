...
<div class="informacion">
	...
	<div class="fila">
		<div class="columna">
			<p>
				<?php esc_html_e( 'If you enjoy this plugin and find it helpful, please make a donation:', 'woocommerce-apg-weight-and-postcodestatecountry-shipping' ); ?>
			</p>
	...
	<div class="fila">
		<div class="columna">
			<p>
				<?php esc_html_e( 'Contact us:', 'woocommerce-apg-weight-and-postcodestatecountry-shipping' ); ?>
			</p>
			<p> <a href="mailto:info@artprojectgroup.es" title="<?php echo esc_attr__( 'Contact us by ', 'woocommerce-apg-weight-and-postcodestatecountry-shipping' ); ?>e-mail"><span class="genericon genericon-mail"></span></a> </p>
		</div>
		<div class="columna">
			<p>
